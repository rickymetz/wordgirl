...
/**
 * The tutorial: the two-line hand-picked grid, with the step script
 * running above the board. Nothing here is persisted — arriving is all it
 * takes to mark the offer answered, so a player who bails halfway is not
 * asked again.
 */
