...
const THEME_POOLS: ThemeGroup[] = [
  ...
  },
  {
    ...
    ["Shakespeare", "Sonnet 29 (When in disgrace with fortune and men's eyes)", "FROM SULLEN EARTH, SINGS HYMNS AT HEAVEN'S GATE"],
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "WHICH BY AND BY BLACK NIGHT DOTH TAKE AWAY"],
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "IN ME THOU SEE'ST THE TWILIGHT OF SUCH DAY"],
  ...
  },
  {
    ...
    ["Byron", "Lines Written in an Album, at Malta", "AS O'ER THE COLD SEPULCHRAL STONE SOME NAME ARRESTS THE PASSER-BY"],
    ...
    ["Byron", "Remembrance", "CHILL'D BY MISFORTUNE'S WINTRY BLAST"],
  ...
  },
  {
    ...
    ["Byron", "Last Words on Greece", "WHAT ARE TO ME THOSE HONOURS OR RENOWN PAST OR TO COME, A NEW-BORN PEOPLE'S CRY?"],
    ...
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "AS THE DEATH-BED, WHEREON IT MUST EXPIRE"],
    ...
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "THAT ON THE ASHES OF HIS YOUTH DOTH LIE, AS THE DEATH-BED, WHEREON IT MUST EXPIRE"],
  ...
  },
  {
    ...
    ["Keats", "To Autumn", "THE RED-BREAST WHISTLES FROM A GARDEN-CROFT"],
    ["Keats", "Ode on a Grecian Urn", "WHAT LEAF-FRING'D LEGEND HAUNTS ABOUT THY SHAPE"],
    ["Byron", "\"By the Waters of Babylon.\"", "ALL STRINGLESSLY HUNG IN THE WILLOW'S SAD TREE"],
  ...
  },
  {
    ...
    ["Byron", "Bowles and Campbell", "TO THE AIR OF HOW NOW, MADAM FLIRT, IN THE BEGGAR'S OPERA"],
    ["Byron", "Bowles and Campbell", "TO THE AIR OF HOW NOW, MADAM FLIRT, IN THE BEGGAR'S OPERA. BOWLES."],
    ...
    ["Byron", "On Revisiting Harrow", "OR FRIENDSHIP'S TEARS, PRIDE RUSH'D BETWEEN"],
    ...
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "IN ME THOU SEE'ST THE GLOWING OF SUCH FIRE"],
