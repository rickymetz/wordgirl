...
const THEME_POOLS: ThemeGroup[] = [
  {
    ...
    ["Byron", "Oh! Weep for Those", "OH WEEP FOR THOSE THAT WEPT BY BABELS STREAM"],
    ["Byron", "Song for the Luddites", "AS THE LIBERTY LADS OER THE SEA"],
    ...
    ["Byron", "Song for the Luddites", "AS THE LIBERTY LADS OER THE SEA BOUGHT THEIR FREEDOM AND CHEAPLY WITH BLOOD"],
    ...
    ["Byron", "Remember Thee! Remember Thee!", "REMEMBER THEE REMEMBER THEE TILL LETHE QUENCH LIFES BURNING STREAM"],
    ["Rossetti", "A Birthday", "MY HEART IS LIKE A SINGING BIRD WHOSE NEST IS IN A WATERD SHOOT"],
    ["Byron", "Versicles", "I READ THE CHRISTABEL VERY WELL"],
    ["Byron", "My Soul Is Dark", "MY SOUL IS DARKOH QUICKLY STRING THE HARP I YET CAN BROOK TO HEAR"],
    ...
    ["Rossetti", "A Birthday", "WHOSE NEST IS IN A WATERD SHOOT"],
    ["Rossetti", "A Birthday", "MY HEART IS LIKE A RAINBOW SHELL THAT PADDLES IN A HALCYON SEA"],
    ["Rossetti", "A Birthday", "WHOSE NEST IS IN A WATERD SHOOT MY HEART IS LIKE AN APPLETREE"],
    ["Blake", "The Lamb", "BY THE STREAM AND OER THE MEAD GAVE THEE CLOTHING OF DELIGHT"],
    ["Blake", "The Lamb", "GAVE THEE LIFE AND BID THEE FEED BY THE STREAM AND OER THE MEAD"],
    ["Rossetti", "A Birthday", "THAT PADDLES IN A HALCYON SEA MY HEART IS GLADDER THAN ALL THESE"],
    ["Keats", "To Autumn", "STEADY THY LADEN HEAD ACROSS A BROOK OR BY A CYDERPRESS WITH PATIENT LOOK"],
  ...
  },
  {
    ...
    ["Issa", "Skinny Frog", "SKINNY FROG DONT GIVE UP ISSA IS HERE WITH YOU"],
    ...
    ["Basho", "Cicada Voice", "NOTHING IN THE CICADAS VOICE GIVES TOKEN OF A SPEEDY DEATH"],
    ...
    english: [
    ["Dickinson", "Split the Lark -- and you\'ll find the Music --", "SPLIT THE LARK AND YOULL FIND THE MUSIC"],
    ...
    ["Dickinson", "The Butterfly\'s Numidian Gown", "THE BUTTERFLYS NUMIDIAN GOWN"],
    ["Dickinson", "The Flower must not blame the Bee", "THE FLOWER MUST NOT BLAME THE BEE"],
    ["Dickinson", "The Butterfly\'s Assumption Gown", "THE BUTTERFLYS ASSUMPTION GOWN"],
    ["Dickinson", "The Butterfly in honored Dust", "THE BUTTERFLY IN HONORED DUST ASSUREDLY WILL LIE"],
    ["Dickinson", "The Butterfly upon the Sky,", "THE BUTTERFLY UPON THE SKY THAT DOESNT KNOW ITS NAME AND HASNT ANY TAX TO PAY"],
    ...
    ["Byron", "Oh! Weep for Those", "THE WILDDOVE HATH HER NEST THE FOX HIS CAVE"],
    ...
    ["Byron", "Stanzas for Music", "WE WILL PART WE WILL FLY TOUNITE IT AGAIN"],
    ["Byron", "Versicles", "I READ GLENARVON TOO BY CARO LAMB"],
    ["Byron", "The Conquest", "NOT FANNED ALONE BY VICTORYS FLEETING WING"],
    ...
    ["Blake", "The Lamb", "LITTLE LAMB ILL TELL THEE HE IS CALLED BY THY NAME FOR HE CALLS HIMSELF A LAMB"],
    ...
    ["Blake", "The Lamb", "LITTLE LAMB ILL TELL THEE LITTLE LAMB ILL TELL THEE"],
    ...
    ["Blake", "The Lamb", "LITTLE LAMB ILL TELL THEE HE IS CALLED BY THY NAME"],
  ...
  },
  {
    ...
    ["Basho", "Rough Sea", "A ROUGH SEA AND THE MILKY WAY STRETCHING ACROSS TO SADOS ISLE"],
    ...
    ["Byron", "I Saw Thee Weep", "I SAW THEE WEEPTHE BIG BRIGHT TEAR"],
    ...
    ["Byron", "My Soul Is Dark", "MY SOUL IS DARKOH QUICKLY STRING"],
    ...
    ["Byron", "So We\'ll Go No More a-Roving", "SO WELL GO NO MORE AROVING SO LATE INTO THE NIGHT"],
    ["Byron", "She Walks in Beauty", "SHE WALKS IN BEAUTY LIKE THE NIGHT OF CLOUDLESS CLIMES AND STARRY SKIES"],
    ["Byron", "Song", "BREEZE OF THE NIGHT IN GENTLER SIGHS MORE SOFTLY MURMUR OER THE PILLOW"],
    ["Byron", "I Saw Thee Weep", "I SAW THEE WEEPTHE BIG BRIGHT TEAR CAME OER THAT EYE OF BLUE"],
    ["Wordsworth", "I Wandered Lonely as a Cloud", "I WANDERED LONELY AS A CLOUD THAT FLOATS ON HIGH OER VALES AND HILLS"],
    ...
    ["Keats", "To Autumn", "CLOSE BOSOMFRIEND OF THE MATURING SUN"],
  ...
  },
  {
    ...
    ["Byron", "Lines Written in an Album, at Malta", "AS OER THE COLD SEPULCHRAL STONE"],
    ["Dickinson", "No Autumn\'s intercepting Chill", "NO AUTUMNS INTERCEPTING CHILL"],
    ["Dickinson", "Summer is shorter than any one --", "SUMMER IS SHORTER THAN ANY ONE"],
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "SHALL I COMPARE THEE TO A SUMMERS DAY"],
    ["Byron", "Epitaph for William Pitt", "WITH DEATH DOOMED TO GRAPPLE BENEATH THIS COLD SLAB HE"],
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "SHALL I COMPARE THEE TO A SUMMERS DAY THOU ART MORE LOVELY AND MORE TEMPERATE"],
    ["Byron", "Lines Written in an Album, at Malta", "AS OER THE COLD SEPULCHRAL STONE SOME NAME ARRESTS THE PASSERBY"],
    ...
    ["Byron", "Journal in Cephalonia", "THE HARVESTS RIPEAND SHALL I PAUSE TO REAP"],
    ["Byron", "Imitated From Catullus. to Ellen", "THE YELLOW HARVESTS COUNTLESS SEED"],
    ...
    ["Byron", "Sun of the Sleepless!", "DISTINCT BUT DISTANTCLEARBUT OH HOW COLD"],
    ["Keats", "To Autumn", "FOR SUMMER HAS OERBRIMMD THEIR CLAMMY CELLS"],
    ...
    ["Byron", "Song to the Suliotes", "HERES THE HARVEST OF OUR LABOUR"],
    ["Keats", "To Autumn", "WHERE ARE THE SONGS OF SPRING AY WHERE ARE THEY"],
    ["Byron", "Remembrance", "CHILLD BY MISFORTUNES WINTRY BLAST"],
    ...
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "AND SUMMERS LEASE HATH ALL TOO SHORT A DATE"],
    ["Byron", "Sonnet on Chillon", "WORN AS IF THY COLD PAVEMENT WERE A SOD"],
    ["Byron", "Sonnet.  to Genevra", "AND THE WARM LUSTRE OF THY FEATURESCAUGHT"],
    ...
    ["Keats", "Ode on a Grecian Urn", "FOR EVER WARM AND STILL TO BE ENJOYD"],
    ...
    ["Keats", "To Autumn", "III WHERE ARE THE SONGS OF SPRING AY WHERE ARE THEY"],
    ["Keats", "Bright Star", "OR GAZING ON THE NEW SOFTFALLEN MASK OF SNOW UPON THE MOUNTAINS AND THE MOORS"],
    ["Keats", "Ode on a Grecian Urn", "THOU SILENT FORM DOST TEASE US OUT OF THOUGHT AS DOTH ETERNITY COLD PASTORAL"],
    ["Keats", "Ode on a Grecian Urn", "MORE HAPPY LOVE MORE HAPPY HAPPY LOVE FOR EVER WARM AND STILL TO BE ENJOYD"],
    ["Keats", "Ode on a Grecian Urn", "YOUR LEAVES NOR EVER BID THE SPRING ADIEU AND HAPPY MELODIST UNWEARIED"],
    ["Keats", "Ode on a Grecian Urn", "FOR EVER WARM AND STILL TO BE ENJOYD FOR EVER PANTING AND FOR EVER YOUNG"],
    ],
  },
  {
    theme: "time",
    ...
    ["Byron", "Journal in Cephalonia", "THE DEAD HAVE BEEN AWAKENEDSHALL I SLEEP"],
    ["Dickinson", "Death leaves Us homesick, who behind,", "DEATH LEAVES US HOMESICK WHO BEHIND"],
    ["Byron", "Translation", "AH GENTLE FLEETING WAVRING SPRITE"],
    ...
    ["Dickinson", "Fame\'s Boys and Girls, who never die", "FAMES BOYS AND GIRLS WHO NEVER DIE"],
    ...
    ["Byron", "On My Wedding-Day", "HERES A HAPPY NEW YEAR BUT WITH REASON"],
    ...
    ["Byron", "To Dives. a Fragment", "UNHAPPY DIVES IN AN EVIL HOUR GAINST NATURES VOICE SEDUCED TO DEEDS ACCURST"],
    ["Byron", "On My Wedding-Day", "HERES A HAPPY NEW YEAR BUT WITH REASON I BEG YOULL PERMIT ME TO SAY"],
    ...
    ["Byron", "To D--", "IN THEE I FONDLY HOPD TO CLASP A FRIEND WHOM DEATH ALONE COULD SEVER"],
    ["Byron", "Last Words on Greece", "WHAT ARE TO ME THOSE HONOURS OR RENOWN PAST OR TO COME A NEWBORN PEOPLES CRY"],
    ["Byron", "To a Lady, on Being Asked My Reason for Quitting England in the Spring", "WHEN MAN EXPELLD FROM EDENS BOWERS A MOMENT LINGERD NEAR THE GATE"],
    ...
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "NOR SHALL DEATH BRAG THOU WANDERST IN HIS SHADE"],
    ["Keats", "To Autumn", "WHILE BARRED CLOUDS BLOOM THE SOFTDYING DAY"],
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "WHEN IN ETERNAL LINES TO TIME THOU GROWST"],
    ["Keats", "Ode on a Grecian Urn", "FAIR YOUTH BENEATH THE TREES THOU CANST NOT LEAVE"],
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "DEATHS SECOND SELF THAT SEALS UP ALL IN REST"],
    ["Keats", "Bright Star", "AND SO LIVE EVEROR ELSE SWOON TO DEATH"],
    ["Shakespeare", "Sonnet 116 (Let me not to the marriage of true minds)", "LOVES NOT TIMES FOOL THOUGH ROSY LIPS AND CHEEKS"],
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "AS THE DEATHBED WHEREON IT MUST EXPIRE"],
    ["Keats", "Ode on a Grecian Urn", "THOU FOSTERCHILD OF SILENCE AND SLOW TIME"],
  ...
  },
  {
    ...
    ["Basho", "Bush Clover", "BUSHCLOVER AND THE MOON AND SIDE BY SIDE WITH THEM TAMAGAWA"],
    ],
    english: [
    ...
    ["Dickinson", "Perhaps you\'d like to buy a flower,", "PERHAPS YOUD LIKE TO BUY A FLOWER"],
    ...
    ["Byron", "Oh! Snatched Away in Beauty\'s Bloom", "OH SNATCHED AWAY IN BEAUTYS BLOOM"],
    ...
    ["Byron", "Oh! Snatched Away in Beauty\'s Bloom", "OH SNATCHED AWAY IN BEAUTYS BLOOM ON THEE SHALL PRESS NO PONDEROUS TOMB"],
    ["Byron", "Stanzas for Music", "THEY ROSE THE FIRSTTHEY SET THE LAST"],
    ...
    ["Byron", "Stanzas to a Lady, With the Poems of CamoëNs", "IN SINGLE SORROW DOOMD TO FADE"],
    ...
    ["Keats", "To Autumn", "THE REDBREAST WHISTLES FROM A GARDENCROFT"],
    ["Keats", "Ode on a Grecian Urn", "WHAT LEAFFRINGD LEGEND HAUNTS ABOUT THY SHAPE"],
    ["Byron", "\"By the Waters of Babylon.\"", "ALL STRINGLESSLY HUNG IN THE WILLOWS SAD TREE"],
    ["Byron", "Stanzas to a Lady, With the Poems of CamoëNs", "IN SINGLE SORROW DOOMD TO FADE THEN READ DEAR GIRL WITH FEELING READ"],
    ["Byron", "Stanzas for Music", "IN AUGHT THAT REMINDS US OF THEE YOUNG FLOWERS AND AN EVERGREEN TREE"],
    ["Rossetti", "A Birthday", "MY HEART IS LIKE AN APPLETREE WHOSE BOUGHS ARE BENT WITH THICKSET FRUIT"],
    ],
  },
  {
    theme: "journey",
    ...
    ["Byron", "Lines Written in \"Letters of an Italian Nun and an  English Gentleman, by J. J. Rousseau;  Founded on Facts.\"", "AWAY AWAYYOUR FLATTERING ARTS"],
    ...
    ["Byron", "On My Thirty-Third Birthday", "THROUGH LIFES DULL ROAD SO DIM AND DIRTY"],
    ...
    ["Dickinson", "The Winters are so short", "THE WINTERS ARE SO SHORT IM HARDLY JUSTIFIED IN SENDING ALL THE BIRDS AWAY"],
    ...
    ["Dickinson", "Somewhat, to hope for,", "SOMEWHAT TO HOPE FOR BE IT NEER SO FAR IS CAPITAL AGAINST DESPAIR"],
    ["Byron", "On My Thirty-Third Birthday", "THROUGH LIFES DULL ROAD SO DIM AND DIRTY I HAVE DRAGGED TO THREEANDTHIRTY"],
    ["Byron", "Lines Written in \"Letters of an Italian Nun and an  English Gentleman, by J. J. Rousseau;  Founded on Facts.\"", "AWAY AWAYYOUR FLATTERING ARTS MAY NOW BETRAY SOME SIMPLER HEARTS"],
    ["Shakespeare", "Sonnet 130 (My mistress\' eyes are nothing like the sun)", "CORAL IS FAR MORE RED THAN HER LIPS RED"],
    ["Byron", "Lines to a Lady Weeping", "COULD WASH A FATHERS FAULT AWAY"],
    ...
    ["Keats", "Ode on a Grecian Urn", "WHY THOU ART DESOLATE CAN EER RETURN"],
    ["Shakespeare", "Sonnet 130 (My mistress\' eyes are nothing like the sun)", "THAT MUSIC HATH A FAR MORE PLEASING SOUND"],
    ["Keats", "Ode on a Grecian Urn", "WILL SILENT BE AND NOT A SOUL TO TELL WHY THOU ART DESOLATE CAN EER RETURN"],
  ...
  },
  {
    ...
    ["Byron", "To M. S. G", "WHEN I DREAM THAT YOU LOVE ME YOULL SURELY FORGIVE"],
    ["Dickinson", "Could that sweet Darkness where they dwell", "COULD THAT SWEET DARKNESS WHERE THEY DWELL"],
    ["Byron", "On the Birth of John William Rizzo Hoppner", "HIS FATHERS SENSE HIS MOTHERS GRACE"],
    ["Byron", "Stanzas for Music", "THERE BE NONE OF BEAUTYS DAUGHTERS"],
    ["Byron", "To Anne", "OH SAY NOT SWEET ANNE THAT THE FATES HAVE DECREED"],
    ["Byron", "From the French", "GLE BEAUTY AND POET HAS TWO LITTLE CRIMES"],
    ...
    ["Dickinson", "Touch lightly Nature\'s sweet Guitar", "TOUCH LIGHTLY NATURES SWEET GUITAR"],
    ...
    ["Byron", "On a Cornelian Heart Which Was Broken", "ILLFATED HEART AND CAN IT BE THAT THOU SHOULDST THUS BE RENT IN TWAIN"],
    ...
    ["Dickinson", "Touch lightly Nature\'s sweet Guitar", "TOUCH LIGHTLY NATURES SWEET GUITAR UNLESS THOU KNOWST THE TUNE"],
    ...
    ["Keats", "Bright Star", "STILL STILL TO HEAR HER TENDERTAKEN BREATH"],
    ["Shakespeare", "Sonnet 73 (That time of year thou mayst in me behold)", "BARE RUIND CHOIRS WHERE LATE THE SWEET BIRDS SANG"],
    ...
    ["Shakespeare", "Sonnet 18 (Shall I compare thee to a summer\'s day?)", "NOR LOSE POSSESSION OF THAT FAIR THOU OWST"],
    ...
    ["Keats", "Ode on a Grecian Urn", "BEAUTY IS TRUTH TRUTH BEAUTYTHAT IS ALL"],
    ...
    ["Shakespeare", "Sonnet 29 (When in disgrace with fortune and men\'s eyes)", "FOR THY SWEET LOVE REMEMBERD SUCH WEALTH BRINGS"],
    ...
    ["Keats", "Ode on a Grecian Urn", "THAT LEAVES A HEART HIGHSORROWFUL AND CLOYD"],
    ["Keats", "Ode on a Grecian Urn", "MORE HAPPY LOVE MORE HAPPY HAPPY LOVE"],
    ["Keats", "Bright Star", "PILLOWD UPON MY FAIR LOVES RIPENING BREAST"],
  ...
  },
  {
    ...
    ["Byron", "On Finding a Fan", "IN ONE WHO FELT AS ONCE HE FELT THIS MIGHT PERHAPS HAVE FANND THE FLAME"],
    ...
    ["Byron", "On Revisiting Harrow", "OR FRIENDSHIPS TEARS PRIDE RUSHD BETWEEN"],
    ...
    ["Byron", "A Fragment", "WHEN POISD UPON THE GALE MY FORM SHALL RIDE"],
    ...
    ["Keats", "To Autumn", "THY HAIR SOFTLIFTED BY THE WINNOWING WIND"],
