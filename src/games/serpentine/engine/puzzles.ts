 ...
 *
 * Phrases are uppercase A–Z plus two display separators: a space
 * between words, a hyphen inside a compound the poet hyphenated
 * (APPLE-TREE, THREE-AND-THIRTY). Neither reaches the grid — `expand`
 * keeps only the letters — but the readout above the board draws both,
 * so a phrase must never run two words together where the source had a
 * dash between them. `corpus.test.ts` guards that.
 */
...
const THEME_POOLS: ThemeGroup[] = [
  {
    ...
    ["Rossetti", "A Birthday", "WHOSE NEST IS IN A WATERD SHOOT MY HEART IS LIKE AN APPLE-TREE"],
  ...
  },
  {
    ...
    ["Kikaku", "Harvest Moon", "AUTUMNS FULL MOON LO THE SHADOWS OF A PINE-TREE UPON THE MATS"],
    ...
    ["Byron", "I Saw Thee Weep", "I SAW THEE WEEP THE BIG BRIGHT TEAR CAME OER THAT EYE OF BLUE"],
  ...
  },
  {
    ...
    ["Byron", "Journal in Cephalonia", "THE HARVESTS RIPE AND SHALL I PAUSE TO REAP"],
    ...
    ["Keats", "To Autumn", "FOR SUMMER HAS OER-BRIMMD THEIR CLAMMY CELLS"],
  ...
  },
  {
    ...
    ["Keats", "Ode on a Grecian Urn", "WHAT LEAF-FRINGD LEGEND HAUNTS ABOUT THY SHAPE"],
  ...
  },
  {
    ...
    ["Byron", "On My Thirty-Third Birthday", "THROUGH LIFES DULL ROAD SO DIM AND DIRTY I HAVE DRAGGED TO THREE-AND-THIRTY"],
  ...
  },
  {
    ...
    ["Keats", "Ode on a Grecian Urn", "THAT LEAVES A HEART HIGH-SORROWFUL AND CLOYD"],
